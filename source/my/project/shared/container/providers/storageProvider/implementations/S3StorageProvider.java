package my.project.shared.container.providers.storageProvider.implementations;
...
public class S3StorageProvider implements IStorageProvider {
	...
	@Override
	public String getFile(final String bucketName, final String fileName) throws FileNotFoundException {
		try {
